...
Accuracy: 86.46%
R^2: 0.9030
Effectiveness for peer running of code:
For this project, I have used a lot of librabies and I believe if you could download the find and be
able to install all
the libraries there should not be any problem. There should be 5 files including README.
Please contact htahiry@elon.edu
in case you face any issues.
Credits:
This video helped a lot to learn tensorflow and LSTM.
https://www.youtube.com/watch?v=94PlBzgeq90
Random Forest Algorithm in Machine Learning
https://www.geeksforgeeks.org/machine-learning/random-forest-algorithm-in-machine-learning/
AI (Chat gpt): I learned a lot by asking questions about different algorithms and also it helped
solve some of the errors. I did not ask it to solve it for me, but “tell me what is wrong with it and
how to solve it?” Also, once I wrote my reports, for fixing the grammar and spelling error I did
ask Chat GPT to help me w
